...
(function (FMS, Backbone, _, $) {
    _.extend(FMS, {
        templates: [
            'home', 'help', 'initial_help', 'around', 'details_entidad', 'details_report_entidad','details_gestion_entidad','ver_report_entidad','offline', 'save_offline', 'reports', 'login', 'address_search', 'existing', 'photo', 'details', 'details_extra', 'submit', 'submit_email', 'submit_name', 'submit_set_password', 'submit_password', 'submit_confirm', 'sent', 'report_entidad'
        ],
        ...
        //currentNewReportEntidad: new FMS.Draft(),
