//Para añadir la parte en donde se verifica que pertenezca a una entidad territorial
    ...
    _.extend( FMS, {
        LoginView: FMS.FMSView.extend({
            ...
            events: {
                ...
                //revisar div id=signed_in_row para hacer aparecer el boton del modulo de entidades.
            },
            ...
            afterDisplay: function ()
            {
                ...
                else if (FMS.isLoggedIn && FMS.currentUser!==null && FMS.body!==undefined)
                {
                        ...
                        success: function( data, status ) {
                            if ( data.name ) {
                                ...
                                if (data.from_body !== undefined) {
                                    ...
                                    //FMS.printDebug('From body: ' + data.from_body);
                                    //FMS.printDebug('Prueba 1: ' + data.name);
                                }
                                else {
                                    that.$('#password_row').hide();
                                    that.$('#success_row').show();
